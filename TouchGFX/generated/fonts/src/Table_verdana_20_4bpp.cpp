...
KEEP extern const touchgfx::GlyphNode glyphs_verdana_20_4bpp[] FONT_TABLE_LOCATION_FLASH_ATTRIBUTE = {
    ...
    {   176, 0x0053,  12,  14,  14,   1,  14,   0,   0, 0x00 },
    {   260, 0x0063,   9,  11,  11,   1,  10,   0,   0, 0x00 },
    {   315, 0x0065,  10,  11,  11,   1,  12,   0,   0, 0x00 },
    {   370, 0x006F,  11,  11,  11,   1,  12,   0,   0, 0x00 },
    {   436, 0x0072,   8,  11,  11,   1,   9,   0,   0, 0x00 }
};
