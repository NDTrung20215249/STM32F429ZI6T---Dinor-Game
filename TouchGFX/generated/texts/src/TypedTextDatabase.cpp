...
extern touchgfx::GeneratedFont& getFont_SNAP_____TTF_30_4bpp();
extern touchgfx::GeneratedFont& getFont_SNAP_____TTF_20_4bpp();

const touchgfx::Font* touchgfx_fonts[] = {
    &(getFont_verdana_20_4bpp()),
    &(getFont_verdana_30_4bpp()),
    &(getFont_verdana_25_4bpp()),
    &(getFont_SNAP_____TTF_30_4bpp()),
    &(getFont_SNAP_____TTF_20_4bpp())
};
...
void resetFont(touchgfx::FontId fontId)
{
    ...
    case 2:
        ...
        break;
    case 3:
        touchgfx_fonts[3] = &(getFont_SNAP_____TTF_30_4bpp());
        break;
    case 4:
        touchgfx_fonts[4] = &(getFont_SNAP_____TTF_20_4bpp());
        break;
    }
}
} // namespace TypedTextDatabase
